    ...
    return (
        <Formik
            ...
            validationSchema={Yup.object({
                title: Yup.string().required('Este campo es Requerido').firstLetterUppercase()
            })}
        >
            {(formikProps) => (
                <Form>
                    ...
                    <TypeAheadActor displayName="Actores" actors={selectedActors} 
                     onAdd={actors => {
                     ...
                     <>
                        {actor.name} / <input placeholder="Personaje" type="text"

                                                        ...
                                                        <div className="gallery-container">
                                                            ...
                                                            <Link to={buildLink()}>
                                                                ...
                                                                <div className="gallery-overlay">
                                                                    <h5 className="overlay-caption"><p>
                <Link to={buildLink()} style={{color:"white"}}>{props.title}</Link>
            </p></h5>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div className="box-content">
                                                            <div className="d-flex align-items-center mt-1">
                                                                <div className="flex-grow-1 text-muted"><a href="" className="text-body text-truncate"><p>
